...
launcher_name="${AGENT_LAUNCHER_NAME:-personal-agent-webui}"
desktop_name="${AGENT_LAUNCHER_DESKTOP_NAME:-personal-agent}"
desktop_display_name="${AGENT_LAUNCHER_DISPLAY_NAME:-Personal Agent}"
desktop_comment="${AGENT_LAUNCHER_COMMENT:-Open the local Personal Agent assistant}"
service_name="${AGENT_LAUNCHER_SERVICE_NAME:-personal-agent-api.service}"
webui_url="${AGENT_LAUNCHER_WEBUI_URL:-http://127.0.0.1:8765/}"
