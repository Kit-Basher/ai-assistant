        ...
        rows.append(
            {
                ...
                "task_types": list(model.get("task_types") or []) if isinstance(model.get("task_types"), list) else [],
                "architecture_modality": str(model.get("architecture_modality") or "").strip().lower() or None,
                "input_modalities": list(model.get("input_modalities") or []) if isinstance(model.get("input_modalities"), list) else [],
                "output_modalities": list(model.get("output_modalities") or []) if isinstance(model.get("output_modalities"), list) else [],
