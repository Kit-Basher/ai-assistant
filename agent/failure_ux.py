...
_FAILURE_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "pack_not_installed": {
        ...
        "next_step": "Inspect a local text-pack directory if you have one. Catalog discovery alone cannot download or install it.",
        "retryable": False,
    ...
    "pack_available_previewable": {
        ...
        "reason": "The catalog describes a possible pack, but discovery is not installation and remote acquisition is unavailable.",
        "next_step": "Inspect the metadata, or provide a local text-pack directory for a separate reviewed install.",
        "retryable": False,
        "recoverability": "user_fixable",
    },
