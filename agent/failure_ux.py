...
_FAILURE_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "pack_not_installed": {
        ...
        "next_step": "Inspect a local pack directory, or request an exact quarantine-fetch preview for a supported source. Discovery alone fetches nothing.",
        "retryable": False,
    ...
    "pack_available_previewable": {
        ...
        "status": "available",
        "state_label": "Available",
        "summary": "Pack metadata is available to inspect.",
        "reason": "The catalog describes a possible pack, but discovery is not acquisition, review, permission, enablement, or installation.",
        "next_step": "Inspect the metadata, then request an exact quarantine-fetch preview for a supported source or provide a local pack directory.",
        "retryable": False,
        "recoverability": "user_fixable",
    },
    ...
    "confirm_token_stale": {
        "category": "approval",
        "status": "stale",
        "state_label": "Approval is stale",
        "summary": "This approval is no longer current.",
    ...
    "confirm_token_consumed": {
        "category": "approval",
        "status": "consumed",
        "state_label": "Approval already used",
        "summary": "This approval was already used.",
    ...
    "confirm_token_expired": {
        "category": "approval",
        "status": "expired",
        "state_label": "Approval expired",
        "summary": "This approval expired.",
    ...
    "confirm_token_mismatch": {
        "category": "approval",
        "status": "mismatch",
        "state_label": "Approval does not match",
        "summary": "That approval does not match the current preview.",
        "reason": "The preview changed or the approval belongs to a different action.",
    ...
    "confirm_downstream_failed": {
        ...
        "next_step": "Check the operation status first. Retry only if it says that nothing changed and retry is safe.",
        "retryable": False,
    ...
    "execution_indeterminate": {
        ...
        "state_label": "Outcome unknown",
        "summary": "The system cannot safely tell whether this operation took effect.",
        "reason": "Execution may have started before the result could be recorded durably.",
        "next_step": "Do not repeat it blindly. Check the current target or delivery status, then reconcile the operation.",
        "retryable": False,
        "recoverability": "reconciliation_required",
    },
