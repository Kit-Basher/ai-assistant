...
def build_user_facing_capability_answer(
    *,
    ...
    text = (
        ...
        "when they are available. I can discover untrusted skill-pack metadata and, after an "
        "exact confirmation, fetch a supported HTTPS or GitHub artifact into quarantine only. "
        "Review, permissions, enablement, and use remain separate steps.\n\n"
        f"{search_clause}\n\n"
