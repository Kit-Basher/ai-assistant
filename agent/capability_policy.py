    ...
    return [
        ...
        *[
            ...
            for capability_id, title, scope, reversibility, external in (
                ...
                ("pack.lifecycle.fetch", "Fetch one exact remote artifact into quarantine", "external_service", "conditionally_reversible", True),
                ("pack.lifecycle.create", "Create one exact assistant draft in quarantine", "local_filesystem", "conditionally_reversible", False),
                ("pack.data.index", "Build one bounded private derived index", "local_filesystem", "reversible", False),
                ("pack.permission.revoke", "Revoke one exact pack broker grant", "local_filesystem", "reversible", False),
