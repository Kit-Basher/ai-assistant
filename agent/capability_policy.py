...
def _default_capabilities() -> list[CapabilityDefinition]:
    return [
        ...
        _capability("backup.create", "Create Backup v1 artifact", "mutating", "local_filesystem", "reversible", "medium", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("backup.restore", "Restore Backup v1 preferences", "mutating", "local_filesystem", "conditionally_reversible", "high", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("files.create", "Create local files", "mutating", "local_filesystem", "reversible", "medium", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("files.modify", "Modify local files", "mutating", "local_filesystem", "conditionally_reversible", "medium", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("files.delete", "Delete local files", "mutating", "local_filesystem", "conditionally_reversible", "high", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("system.service.restart", "Restart local service", "mutating", "local_host", "reversible", "high", "plan_and_confirm", implementation_status="legacy_unmigrated"),
        _capability("system.service.stop", "Stop local service", "mutating", "local_host", "reversible", "high", "plan_and_confirm", implementation_status="legacy_unmigrated"),
    ]
