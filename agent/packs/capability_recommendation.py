...
_CAPABILITY_RULES: dict[str, dict[str, Any]] = {
    ...
    "pdf_table_extraction": {
        ...
        "search_terms": ("pdf", "table", "tables", "extraction"),
        "installed_blocker": "it isn't enabled as a live capability yet",
        "blocked_blocker": "the pack was blocked during import",
    },
...
_CAPABILITY_HELPER_NAMES = {
    ...
    "pdf_table_extraction": "PDF table extraction helper",
...
_CAPABILITY_PROPOSAL_SUMMARIES = {
    ...
    "pdf_table_extraction": "extracts tables from user-provided PDFs through an approved reviewed skill path",
