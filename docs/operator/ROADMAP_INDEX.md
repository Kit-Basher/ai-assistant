...
| v0.2.5 assistant personality and memory UX | `docs/operator/ASSISTANT_PERSONALITY_MEMORY_UX_V0_2_5.md` |
...
Audit v2D implementation is `agent/provider_model_authorization.py`; its domain
inventory is generated by `scripts/provider_model_authorization_audit.py`, and
the global inventory remains generated by `scripts/architecture_safety_audit_v2.py`.
DNS-rebinding-resistant provider connection enforcement remains a named
security/release blocker; hostname validation alone is not complete SSRF
