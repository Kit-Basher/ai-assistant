...
class TestThreadsIndex(unittest.TestCase):
    ...
    def test_threads_lists_recent_order_with_focus(self) -> None:
        ...
        self.assertEqual("1) thread-b 2099-01-02T00:00:00+00:00 Focus: (none)", lines[1])
        self.assertEqual("2) thread-a 2099-01-01T00:00:00+00:00 Focus: Alpha focus", lines[2])
        self.assertEqual("3) thread-c 2099-01-01T00:00:00+00:00 Focus: (none)", lines[3])
