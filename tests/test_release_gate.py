...
class TestReleaseGate(unittest.TestCase):
    def test_release_gate_lists_expected_commands(self) -> None:
        ...
        self.assertIn(" -m py_compile", rendered)
        self.assertIn("scripts/assistant_viability_smoke.py", rendered)
        self.assertIn("scripts/restart_memory_smoke.py", rendered)
        self.assertIn("scripts/provider_matrix_smoke.py", rendered)
        self.assertIn("scripts/assistant_real_world_smoke.py", rendered)
        self.assertIn("scripts/assistant_interaction_barrage.py", rendered)
