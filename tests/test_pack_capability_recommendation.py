...
class TestPackCapabilityRecommendation(unittest.TestCase):
    ...
    def test_youtube_history_gap_returns_scaffold_preview_offer_not_browser_automation(self) -> None:
        ...
        self.assertIn("say yes to preview it", str(result.get("summary") or "").lower())
        self.assertIn("browser automation would not safely solve", str(result.get("summary") or "").lower())
