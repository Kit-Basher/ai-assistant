...
def test_domain_request_with_can_you_do_preamble_routes_to_system_status(runtime: AgentRuntime) -> None:
    response = _chat(
        runtime,
        "Would you mind checking the machine and telling me whether RAM is being consumed heavily?",
        thread="wp6-resource-domain",
    )
    understanding = _understanding(response)
